...
public class Translator {
	...
	private ServiceLocator service = ServiceLocator.getServiceLocator();
	private Logger logger = service.getLogger();
    ...
    public Translator(String localeString) {
        ...
        if (localeString != null) {
            Locale[] availableLocales = service.getLocales();
        ...
        resourceBundle = ResourceBundle.getBundle(service.getAPP_CLASS().getName(), locale);
